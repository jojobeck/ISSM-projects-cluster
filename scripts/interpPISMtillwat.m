function output = interpPISMtillwat(X,Y,string,method,ncdate)
...
if nargin<3, string = 'tillwat'; end
if nargin<4
...
basename = 'tas_1853-07-02T12:00:00.nc';
...
if strcmp(string,'icemask'),
	...
	% data  = double(ncread(ncfile,string,[1 id1x id1y],[1, id2x-id1x+1 id2y-id1y+1],[1 1 1]))';
	% data  = double(ncread(ncfile,string,[1 id1x id1y],[1 id2x-id1x+1 id2y-id1y+1],[1 1 1]))';
	xdata=xdata(id1x:id2x);
	ydata=ydata(id1y:id2y);
end
