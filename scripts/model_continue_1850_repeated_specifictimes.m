function md = model_continue_1850_repeated_secifictimes(md_in,i)
    ...
    md.miscellaneous.name=['1850repeated_timeyear_', num2str(time), '_',md_in.miscellaneous.name];
    ...
    %Load forcing data
    load './../Data/Atmosphere/ukesm_1850_repeat_smb.mat',
    load './../Data/Ocean/ukesm_1850_repeated_tf.mat'
    ...
    miroc_rcp85_smb(1:end-1,:) = ukesm_smb_1850_repeat(1:end-1,:);
