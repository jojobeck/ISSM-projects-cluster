function results =ananlyze_hist2_exp_ocean95percentile(name);
    ...
    name_save = ['./Data/Tables/analysisRuns_hist2_ocean95percentile_' name '_withparalell.mat'];
    ...
    namo = parts2{1};
    name_table = ['./Data/Tables/','min_distance_hist2_runs_ocean95percnetile_' namo '.txt'];
    ...
    name_table = ['./Data/Tables/','time_min_distance_hist2_runs_ocean95percentile_' namo '.txt'];
    ...
    name_table = ['./Data/Tables/','weighted_within_exptype_ocean95percentile_' namo '.txt'];
    ...
    name_table = ['./Data/Tables/','orderd_experiments_weighted_within_exptype_ocean95percentile_' namo '.txt'];
