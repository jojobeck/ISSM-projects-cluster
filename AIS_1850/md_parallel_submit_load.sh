...
#PBS -o HistSubmitload.outlog
#PBS -e HistSubmitload.errlog
...
matlab -nodisplay -nosplash -r " addpath $ISSM_DIR/src/m/dev; devpath; addpath $ISSM_DIR/lib outputDir='$PBS_JOBFS',numberOfWorkers=$PBS_NCPUS, run('hist1_from_1850climmean_func(${stephist1},1)') , quit" > Hist1fromClimSubmitload.log
