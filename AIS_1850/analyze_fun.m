...
if perform(org,'-1930_nobasal_melt_nonlocal_2ka_Cfriction_mean_SMB4x'),% {{{
    ...
    % for i =10:10,
        disp(i);
        name=['historic_from_',num2str(i),'_-1930_from_2ka_Cfriction_mean_SMB4_submit.mat'];
        % gl_name=['historic_from_',num2str(i),'_-1930_from_1ka_2INVCfriction_mean_SMB4_gl_transientend.exp'];
        pvel = './Models/';
        save_p= [pvel, name];
        md = loadmodel(save_p);
...
if perform(org,'-1930_nobasal_melt_nonlocal_2ka_Cfriction_nn_SMB4x'),% {{{
    ...
    % for i =10:10,
        disp(i);
        name=['historic_from_',num2str(i),'_-1930_from_2ka_Cfriction_nn_SMB4_submit.mat'];
        % gl_name=['historic_from_',num2str(i),'_-1930_from_1ka_2INVCfriction_mean_SMB4_gl_transientend.exp'];
        pvel = './Models/';
        save_p= [pvel, name];
        md = loadmodel(save_p);
        ...
        T = table(model_names,steps_all,dist_PIG_pd_all,dist_THW_pd_all,dist_Moscow_pd_all,dist_Totten_pd_all,dist_to_PIG1940_all,dist_to_THW1992_all); 
        name_table = ['./Data/Tables/','historic_until_1930_from_2ka_Cfriction_nn_SMB4_submit'];
        writetable(T, name_table) ;
    ...
    if perform(org,'-1930_from_2ka_RedoforTHW_nobasal_melt_nonlocal_2ka_Cfriction_mean_SMB4x'),% {{{
        ...
        % for i =10:10,
            disp(i);
            name=['historic_from_',num2str(i),'_-1930_from_2ka_2INVCfriction_mean_SMB4_submit.mat'];
            % gl_name=['historic_from_',num2str(i),'_-1930_from_1ka_2INVCfriction_mean_SMB4_gl_transientend.exp'];
            pvel = './Models/';
            save_p= [pvel, name];
            md = loadmodel(save_p);
            ...
            T = table(model_names,steps_all,dist_PIG_pd_all,dist_THW_pd_all,dist_Moscow_pd_all,dist_Totten_pd_all,dist_to_PIG1940_all,dist_to_THW1992_all); 
            name_table = ['./Data/Tables/','historic_until_1930_from_2ka_2INVCfriction_mean_SMB4_experiment.txt'];
            writetable(T, name_table) ;
