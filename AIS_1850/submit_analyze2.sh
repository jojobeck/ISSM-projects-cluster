...
#PBS -o Analyze4.outlog
#PBS -e Analyze4.errlog
...
# argName='$arg'
matlab -nodisplay -nosplash -r " addpath $ISSM_DIR/src/m/dev; devpath; addpath $ISSM_DIR/lib outputDir='$PBS_JOBFS',numberOfWorkers=$PBS_NCPUS, run('analyze_fun(${step})') , quit" > Analyze_${PBS_JOBID}.log
