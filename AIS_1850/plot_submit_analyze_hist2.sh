...
#PBS -o PlotAnalyzeHist2.outlog
#PBS -e PlotAnalyzeHist2.errlog
...
matlab -nodisplay -nosplash -r " addpath $ISSM_DIR/src/m/dev; devpath; addpath $ISSM_DIR/lib outputDir='$PBS_JOBFS',numberOfWorkers=$PBS_NCPUS, run('plot_hist2_analyze(${step},1)') , quit" > PlotAnalyzeHist2.log
